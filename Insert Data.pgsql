...
INSERT INTO delivery (customerUsername, orderID, delivery_status, sellerID)
VALUES('solocup', 1, 'DELIVERED', 15),
('solocup', 2, 'DELIVERED',13), 
('solocup', 2, 'DELIVERED', 11),
('drinkdrank', 3, 'DELIVERED', 12),
('drinkdrank', 3, 'DELIVERED', 11),
('drinkdrank', 3, 'DELIVERED', 12),
('brewbeer', 4, 'ON THE WAY', 11),
('shotsonme', 5, 'SHIPPED', 12),
('beerpong', 6, 'ON THE WAY', 12),
('solocup', 7, 'ON THE WAY', 15),
('drinkdrank', 8, 'DELIVERED', 12),
('drinkdrank', 8, 'DELIVERED', 15),
('brewbeer', 9, 'SHIPPED', 13),
('shotsonme', 10, 'SHIPPED', 15),
('beerpong', 11, 'ON THE WAY', 14),
('beerpong', 11, 'ON THE WAY', 12);

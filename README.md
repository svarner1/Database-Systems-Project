...
# Project Goal
As part of the course Database Systems, our team worked on a semester-long group project to develop a database for a hypothetical system. We created a database for an e-commerce using **Postgresql** and **Visual Studio Code**
